package strava.filedownload.controller;
...
import strava.filedownload.service.FileDownloadService;
...
public class FileDownloadController {
	...
	public void downloadFile(CommandMap commandMap, HttpServletResponse response) throws Exception{
	    ...
	    byte fileByte[] = FileUtils.readFileToByteArray(new File("D:\\dev\\uploadfiles\\"+storedFileName));
